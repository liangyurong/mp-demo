...
public class StuController {
   ...
   * 前端传递dto，后端保存实体类
   *
   * <p>示例：{ "name":"222", "myEmail":"ddddd" } postman要选择post，下面点击raw和选择JSON
   *
  ...
  public static void main(String[] args) {
    ...
    BigDecimal b = new BigDecimal("368.30");
  ...
  /**
   * 分页和条件查询 示例：http://localhost:8888/student/page?current=1&size=3
   *
